...
module.exports = {
  search: function(query) {
    ...
    var search_url = settings.YTS_URL + '/api/v2/list_movies.json?query_term=' + encodeURIComponent(query) + '&sort=seeds&order=desc&set=1';
        ...
        if(data.data.movie_count > 0){
          ...
          for(var torrent in data.data.movies){
            ...
            for(var torrents in data.data.movies[torrent].torrents){
              ...
              var torrent_link = "https://yts.ag/torrent/download/" + hash + ".torrent";
